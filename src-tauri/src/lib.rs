...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::progress::get_progress_metrics,
            commands::progress::set_progress_inputs,
            ...
            commands::teller::teller_get_status,
            commands::teller::teller_save_config,
            commands::teller::teller_add_enrollment,
            commands::teller::teller_sync,
            ...
            commands::ai::ai_list_threads,
            commands::ai::ai_create_thread,
            commands::ai::ai_rename_thread,
            commands::ai::ai_delete_thread,
            commands::ai::ai_get_thread_messages,
            commands::ai::ai_append_message,
        ])
